...
| tags | [ ] https://github.com/restorecommerce/protos/blob/master/io/restorecommerce/access_control.proto[`io.restorecommerce.access_control.Attribute`] | optional | The tag-set for the object. The tag-set is used for filtering by tag
|==============================================================================================================================================
